...
import OsaDocumentTypesTableHead from "./OsaDocumentTypesTableHead";
import OsaDocumentTypesTableBody from "./OsaDocumentTypesTableBody";

const OsaDocumentTypesTable = ({
  data,
...
export default OsaDocumentTypesTable;
