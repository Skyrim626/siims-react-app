  ...
  return (
    <div className="bg-gray-100 p-8 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-6">
        <img src="/src/assets/images/logo/USTP-Logo-against-Light.png" alt="School Logo" className="h-16 w-auto" />
        <h1 className="text-2xl font-bold text-center">
          University of Science and Technology of Southern Philippines
        </h1>
        <img src="/src/assets/images/logo/CITC_LOGO.png" alt="School Logo" className="h-16 w-auto" />
      </div>
      ...
      <div id="letter-content" className="bg-white shadow-lg rounded-lg p-6">
        ...
        <p className="mb-4">
          I hope this letter finds you well and in good spirits. I am writing to express my sincerest gratitude for taking
          the time to read this request on behalf of the <span className="font-semibold">{data.college}</span> at the
          University of Science and Technology of Southern Philippines (USTP).
        </p>

        <p className="mb-4">
          As you may be aware, the fourth-year students of our <span className="font-semibold">{data.program}</span>{" "}
          program are currently in their final semester of their course. As part of their graduation requirements, they must
          complete a mandatory On-the-Job Training (OJT) program, with a duration of 486 hours between February and May{" "}
          {data.year}.
        </p>

        <p className="mb-4">
          In light of this, I would like to respectfully request your consideration in accepting the following student(s):
        </p>
          ...
          <tbody>
            {data.endorse_students.map((student, index) => (
              <tr key={index}>
                ...
                <td className="border border-gray-300 px-4 py-2">{student.phone_number}</td>
              </tr>
            ))}
          </tbody>
        </table>
        ...
        <p className="mb-4">
          Thank you for considering this request. Should you have any questions, please contact us.
        </p>
      </div>
