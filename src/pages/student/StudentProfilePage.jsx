...
const StudentProfilePage = () => {
  ...
  const exportToPDF = () => {
    ...
    const checkPageHeight = () => {
      if (yPosition > 270) { // Check if content exceeds 270 (a little above the bottom margin)
  ...
  return (
    <div ref={profileRef} className="container mx-auto p-6 bg-white rounded-lg shadow-lg space-y-6">
    {/* Header Section */}
